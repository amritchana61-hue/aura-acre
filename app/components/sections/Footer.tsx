...
const quickLinks = ['Home', 'Listings', 'Neighbourhoods', 'About', 'Contact']
const neighbourhoodLinks = ['Yorkville', 'King West', 'Forest Hill', 'Rosedale', 'Distillery District']
...
export default function Footer() {
  return (
    <footer className="bg-[#011C40] py-16 px-6 md:px-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-white/60 mb-2">hello@auraacre.ca</p>
            <p className="text-sm text-white/60 leading-relaxed">
              1 King Street West, Suite 4800<br />Toronto, ON M5H 1A1
            </p>
          </div>
        </div>
